...
model = joblib.load("model_klasifikasi_kopi_joblib")
...
if st.button("Prediksi", type="primary"):
    data = pd.DataFrame([[kadar_kafein, tingkat_keasaman, jenis_proses]],
...
st.divider()
st.caption("Dibuat dengan ☕ oleh **Iklil Baihaqi**")